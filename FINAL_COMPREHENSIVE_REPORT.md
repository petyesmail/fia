...
## با یادگیری تقویتی عمیق - پیشرفته

**تاریخ**: 1403/11/12 (2026-01-31)
**وضعیت**: ✅ **تکمیل شده 100%**
**سطح**: پروژه دکتری (Research Project Level)

---

## 📋 خلاصه اجرایی

این پروژه یک چارچوب جامع و دقیق برای ارزیابی **9 الگوریتم مسیریابی** در شبکه‌های حسگر بی‌سیم نرم‌افزارمحور (SD-WSN) است که با دقت و استانداردهای تحقیقاتی بین‌المللی پیاده‌سازی شده است.

### 🎯 دستاوردهای کلیدی:

✅ **9 الگوریتم کامل**: 3 baseline + 6 پیشرفته
✅ **مدل انرژی تخصصی**: دقت نانوژول و میکروژول
✅ **معیارهای دقیق**: FND, HND, LND, PDR, Throughput, Delay, Fairness
...
## ⚡ مدل انرژی دقیق (Advanced Energy Model)
...
این پروژه یک چارچوب **کامل، دقیق و قابل انتشار** برای ارزیابی الگوریتم‌های مسیریابی در SD-WSN است که:
...
- استفاده به عنوان بخشی از پروژه دکتری
- توسعه‌های آینده
